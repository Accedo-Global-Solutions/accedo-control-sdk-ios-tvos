Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.platform     = :ios
  s.vendored_frameworks = 'Release/1.0.11/AccedoOneiOS.framework'
  s.ios.deployment_target  = "9.0"
  s.source = { 
	:http => 'https://github.com/Accedo-Products/accedo-one-sdk-ios-tvos/blob/master/Release/1.0.11/AccedoOneiOS.zip?raw=true'
  }
end
